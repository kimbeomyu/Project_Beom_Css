    ...
    <nav class="navbar navbar-expand-md">
      ...
      <div class="collapse navbar-collapse" id="navbarsExample03">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item"> <a class="nav-link" href="/views/selfGuide/write.jsp">Write</a></li>
          ...
          <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="/img2/main.jpg" alt="Los Angeles" style="width: 100%; height: 500px">
              </div>
              <div class="carousel-item">
                <img src="/img2/main2.webp" alt="Chicago" style="width: 100%; height: 500px">
              </div>
              <div class="carousel-item">
                <img src="/img2/main5.jpg" alt="New York" style="width: 100%; height: 500px">
              </div>
            </div>
                  ...
                  <li>
                    <a href="">
                      <div class="screen">
                        ...
                        <div class="rankbottom">ê¸ì´ì´ID</div>
                        <!--íì¤í¸-->
                        <img src="/img2/maincontent10.jpg">
                      </div>
