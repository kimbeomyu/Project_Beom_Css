...
/**
 * Servlet implementation class GuideCommentAddServlet
 */
@WebServlet("/guideCommentAdd")
public class GuideCommentAddServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GuideCommentAddServlet() {
        super();
